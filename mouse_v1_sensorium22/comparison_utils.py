...
# def old_plot_reconstructions_publication(runs_to_compare, stim, config, save_to=None):
...
# def plot_reconstructions_publication(runs, stim, stim_label="Target", crop_win=None, save_to=None):
...
#         ax.set_title(title, fontsize=10, rotation=60, va="baseline")
