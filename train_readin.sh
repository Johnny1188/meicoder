...
OUTPUT_FILE=readin_training_${SLURM_JOB_ID}.ipynb
jupyter nbconvert --to notebook --execute --allow-errors --output $OUTPUT_FILE csng/imagenet/readin_training.ipynb
